...
-- -----------------------------------------------------
-- Table `sakila`.`Paciente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Paciente` (
  `Id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `sakila`.`Medicamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Medicamento` (
  `Id` INT NOT NULL,
  `Nome` VARCHAR(45) NULL,
  `Dose_Diaria` VARCHAR(45) NULL,
  `Dias_Tratamento` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `sakila`.`Receita`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Receita` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `Id_Paciente` INT NOT NULL,
  `Id_Medicamento` INT NOT NULL,
  `Quantidade` INT NULL,
  PRIMARY KEY (`Id`),
  INDEX `fk_Receita_Paciente1_idx` (`Id_Paciente` ASC),
  INDEX `fk_Receita_Medicamento1_idx` (`Id_Medicamento` ASC),
  CONSTRAINT `fk_Receita_Paciente1`
    FOREIGN KEY (`Id_Paciente`)
    REFERENCES `sakila`.`Paciente` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Receita_Medicamento1`
    FOREIGN KEY (`Id_Medicamento`)
    REFERENCES `sakila`.`Medicamento` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `sakila`.`Leito`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Leito` (
  `Id` INT NOT NULL,
  `Id_Paciente` INT NOT NULL,
  `Nome` VARCHAR(45) NULL,
  PRIMARY KEY (`Id`),
  INDEX `fk_Leito_Paciente1_idx` (`Id_Paciente` ASC),
...
-- -----------------------------------------------------
-- Table `sakila`.`Estoque`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Estoque` (
  `Id` INT NOT NULL,
  `Medicamento_Id` INT NOT NULL,
  `Caixas_Disponivel` INT NULL,
  `Doses_Caixa` INT NULL,
  `Estoquecol` INT NULL,
  `Preco_Caixa` FLOAT NULL,
  PRIMARY KEY (`Id`),
  INDEX `fk_Estoque_Medicamento1_idx` (`Medicamento_Id` ASC),
